...
const IndexPage = () => (
  <div className="text-center bg-white ">
    ...
    <h2 className="inline-block my-8 p-3 uppercase leading-loose w-full mx-auto font-title">
    ...
    <div className="flex rounded border-b-2 border-grey-dark overflow-hidden">
      ...
      <div className="bg-blue-light shadow-border p-3">
        <div className="w-4 h-4">
          <svg className="fill-current text-white"  viewBox="0 0 200 200" version="1.1" xmlns="http://www.w3.org/2000/svg">
